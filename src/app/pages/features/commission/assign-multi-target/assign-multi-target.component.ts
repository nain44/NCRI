...
export class AssignMultiTargetComponent implements OnInit {
  ...
  openLimitModal() {
    this.modalRef = this.modalService.show(this.limitModal);
  }
 ...
 for (var i = 0; i < list.length; i++) {
   ...
   if (list[i].grade === lastGrade) {
           ...
           <div class="row">
               <div class="col-md-6">
                   <div class="form-group">
                       <label >Level ${list[i].grade}</label>
               ...
               <div class="col-md-6">
                   <div class="form-group">
                       ...
                       <input type="text" id="${list[i].id}"  class="form-control" placeholder="Enter Target Amount" > 
                   </div>
               </div>
           </div>
       </div>
     ...
     p.append(li);
     document.getElementById(list[i].id).addEventListener('blur', this.modelChanged);
   } else {
       ...
       <i class="indicator" (click)="setCollaps(${'parent' + (i + 1)})"></i>
           <div class="row">
               ...
               <div class="col-md-6">
                   <div class="form-group">
                       <label >Target Amount</label>
                       <input id="${list[i].id}" type="text" class="form-control"   placeholder="Enter Target Amount" > 
                   </div>
               </div>
           </div>
